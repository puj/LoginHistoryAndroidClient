...
public class LoginClickListener implements android.view.View.OnClickListener{
	...
	public LoginClickListener(EditText usernameField, EditText passwordField) {
		mUsernameField = usernameField;
		mPasswordField = passwordField;
	}

	public void onClick(View view) {
		// Got a login button press
		if(view.getId() == R.id.btnSubmit){
			
			// Construct the target URL
			final String url = 	"http://" + 
								view.getContext().getString(R.string.default_login_hostname) + ":" + 
								view.getContext().getString(R.string.default_server_port) ;
			...
			final String passwordAndSalt = username + mPasswordField.getText().toString() + salt;
		    ...
		    try {
	            ...
	            SharedPreferences prefs = view.getContext().getSharedPreferences(
	            		view.getContext().getString(R.string.shared_preferences_filename), 
